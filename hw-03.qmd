...
pacman::p_load(tidyverse, here, glue, scales, janitor)
...
income_clean |>
  ggplot(aes(x = class, y = amount, fill = spending_type)) +
  geom_bar(stat = "identity", position = "fill") +
  coord_flip() +
  scale_fill_manual(values = c("pink","purple","grey", "black", "skyblue"))
