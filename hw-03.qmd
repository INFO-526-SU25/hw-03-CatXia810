...
```
The first pivot longer is taking all the explanatory values (ie background info) and puting it in explanatory_value while the second pivot longer is taking all the response and putting them under response_value.
